    ...
    <div className='detail-container'>
        <DetailHeader title="Precipitation" icon={WiShowers} />
         <div className='flex text-5xl my-4 items-center'>
            <p data-testid='precip-p' className='mx-2'>{units === 'Metric' ? forecast.current.precip_mm : forecast.current.precip_in}<span data-testid='precip-span' className='text-lg'>{units === 'Metric' ? ' mm' : ' in'}</span></p>
        </div>
