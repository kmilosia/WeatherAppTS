  ...
  return (
    <div className='detail-container'>
        ...
        <div className='flex text-5xl my-4 items-center'>
            <p data-testid='pressure-p' className='mx-2'>{units === 'Metric' ? forecast.current.pressure_mb : forecast.current.pressure_in}<span data-testid='pressure-span' className='text-lg'>{units === 'Metric' ? ' mb' : ' in'}</span></p>
